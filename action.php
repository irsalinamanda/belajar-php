...
if(isset($_GET['p'])) {
    ...
    if ($_GET['p'] == 'tampil') { // standar
        ...
        $size = getimagesize($_FILES['file']['tmp_name']); // mengambil size
        $image = "data:".$size['mime'].";base64,".base64_encode(file_get_contents($_FILES['file']['tmp_name'])); // menampilkan gambar
